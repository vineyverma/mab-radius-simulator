...
public class RadiusAccountingStart {
	...
	final static String USERNAME = System.getProperty("USERNAME", "mud_user1");
	...
	final static String HOSTNAME = System.getProperty("HOSTNAME","tb071-ise3.cisco.com");
	final static String MUD_URI = System.getProperty("mud_uri",
	...
	public static void main(String[] args) throws Exception {
		...
		RadiusPacket resp = start(channel, USERNAME, PASSWORD, MUD_URI);
		System.out.println(resp.toString());
		
		channel.close();
	}

	static RadiusPacket start(DatagramChannel channel, String username, String password, String mudURI) throws Exception {
